...
export default async function PlanesPage() {
  ...
  const [subscription, invoices, plans, addons, companyName] = await Promise.all([
  ...
  return (
    <div className="space-y-4">
      ...
      <InvoicesTable invoices={invoices} canPay={can(permissions, "pagos.create")} companyName={companyName} />
    </div>
  );
}
